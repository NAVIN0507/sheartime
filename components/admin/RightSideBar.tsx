...
const RightSideBar = ({session}:{session : Session}) => {
  ...
  return (
<section className=' left-0 top-0  flex min-h-screen w-fit flex-col justify-between bg-primary-1 text-black shadow-2xl p-6 pt-32 text-3xl max-sm:hidden lg:w-[300px] '>
  <div className='-mt-28'>
  ...
  <div className='flex flex-1 flex-col gap-6 mx-auto fixed mt-[150px]'>
    ...
    {AdminSideBar.map((link)=>{
      ...
      return( 
        ...
        } className={cn('flex flex-row h-[60px] gap-7 items-center w-full text-black  shadow-none p-4 rounded-lg justify-start hover:shadow-md hover:bg-graphite-1 hover:text-primary-1' , {'bg-graphite-1 text-primary-1' :''})}>
